...
<body>
 <div class="banner">AI-DRAFTED &mdash; PENDING LAWYER REVIEW. This document was generated by RIHAI SETU to accelerate paperwork. It must be reviewed and verified by a DLSA lawyer or the Jail Superintendent before filing. No court filing occurs automatically.</div>
    ...
    if (flaggedApp) {
      ...
      application = await prisma.application.update({
        ...
        data: {
          ...
          stageHistory: {
            [ApplicationStage.Flagged]: flaggedApp.updatedAt.toISOString(),
            [ApplicationStage.Drafted]: nowIso,
          },
        },
      ...
      application = await prisma.application.create({
        data: {
          ...
          generatedDocumentUrl: stored.url,
          stageHistory: {
            [ApplicationStage.Flagged]: nowIso,
            [ApplicationStage.Drafted]: nowIso,
          },
        },
        include: { reviewer: { select: { name: true } } },
