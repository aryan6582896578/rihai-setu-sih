...
const T: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "mission.title": "Built with District Legal Services Authorities",
    "mission.note": "Piloted alongside NALSA, state DLSAs and prison administrations",

    "stat1.num": "75.8%",
    "stat1.label": "of India's prison inmates are undertrials",
    "stat1.src": "NCRB Prison Statistics India 2022",
    "stat2.num": "5.73 lakh",
    "stat2.label": "undertrials behind bars awaiting trial outcomes",
    "stat2.src": "NCRB Prison Statistics India 2022",
    "stat3.num": "131%",
    "stat3.label": "average occupancy across Indian prisons",
    "stat3.src": "NCRB Prison Statistics India 2022",
    "stat4.num": "1/3rd",
    "stat4.label":
    ...
    "feat2.p":
      "Bail and personal-bond applications are drafted with AI-assisted grounds narratives for a lawyer's review — never auto-filed.",
    ...
    "partners.kicker": "Working alongside",
    ...
    "demo.super.role": "Superintendent — Rampur",
    ...
    "nav.overcrowding": "Overcrowding",
    "role.super_admin": "Super Admin",
    "role.jail_superintendent": "Jail Superintendent",
    "role.jail_staff": "Jail Staff",
    "role.dlsa_lawyer": "DLSA Lawyer",
    "role.viewer": "Viewer",
    ...
    "stall.empty.h": "Nothing stalled right now",
    "stall.empty.p":
      "Cases that stop moving past their per-stage threshold will surface here automatically.",
  },
  ...
  hi: {
    ...
    "mission.title": "जिला विधिक सेवा प्राधिकरणों के सहयोग से निर्मित",
    "mission.note": "नालसा, राज्य डीएलएसए और जेल प्रशासन के साथ प्रायोगिक रूप से लागू",

    "stat1.num": "75.8%",
    "stat1.label": "भारत के जेल कैदियों में विचाराधीन कैदियों का हिस्सा",
    "stat1.src": "एनसीआरबी जेल सांख्यिकी भारत 2022",
    "stat2.num": "5.73 लाख",
    "stat2.label": "विचाराधीन कैदी सुनवाई के परिणाम की प्रतीक्षा में",
    "stat2.src": "एनसीआरबी जेल सांख्यिकी भारत 2022",
    "stat3.num": "131%",
    "stat3.label": "भारतीय जेलों में औसत क्षमता उपयोग",
    "stat3.src": "एनसीआरबी जेल सांख्यिकी भारत 2022",
    "stat4.num": "1/3",
    ...
    "feat2.p": "जमानत व निजी-बॉन्ड आवेदन एआई-सहायता प्राप्त आधार विवरण के साथ तैयार किए जाते हैं, वकील की समीक्षा हेतु — कभी स्वतः दाखिल नहीं होते।",
    ...
    "partners.kicker": "सहयोगी संस्थाएँ",
    ...
    "demo.super.role": "अधीक्षक — रामपुर",
